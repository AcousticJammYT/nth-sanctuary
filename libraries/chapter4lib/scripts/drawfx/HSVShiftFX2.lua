---@class HSVShiftFX2: ShaderFX
---@field shader love.Shader
local HSVShiftFX2, super = Class(ShaderFX)

function HSVShiftFX2:init(heartbeat, priority)
...
function HSVShiftFX2:draw(texture)
