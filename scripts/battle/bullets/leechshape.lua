local LeechShape, super = Class(Bullet)

function LeechShape:init(x, y)
    super.init(self, x, y, "bullets/darkspace/leechshape_animated")
    ...
    self.frames_shrink = Assets.getFrames("bullets/darkspace/leechshape")


    self.normal_frames = Assets.getTexture("bullets/darkspace/leechshape_animated_1")
